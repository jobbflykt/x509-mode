...
* TODO Add support for -strparse N argument in x509-asn1-mode.
...
((what offset hl))
(('strparse 4 2) ('strparse 10 2) ('offset 8 0))
...
-strparse 4  :  push ('strparse 0 2 (point))

-strparse (+ 6 2) :   push ('strparse 4 2 (point))
