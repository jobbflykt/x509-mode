...
to the asn1parse command. The OCTET STRING is itsef an ANS.1 struct starting at
offset 651 + 2.
...
x509-asn1-mode must store a list of offest that can be pushed and popped when
going down and up.
